...
namespace NConvert.cvc20beta_dnt21202
{
    public partial class Provider : IProvider
    {
        ...
        {
            return Convert.ToInt32(MainForm.GetSrcDBH_OldVer().ExecuteScalar(string.Format("SELECT COUNT([Id]) FROM {0}Subject", MainForm.cic.SrcDbTablePrefix)));
        ...
        public List<TopicTypes> GetTopicTypeList()
        {
            ...
            System.Data.Common.DbDataReader dr = MainForm.GetSrcDBH_OldVer().ExecuteReader(sqlTopicTypes);
